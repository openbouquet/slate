...
The `period`definition must resolve to a simple Dimension - so in practice you cannot use function here. Note that there is two way you can reference a dimension:
